...
function mapOrderFromJs(orderJs) {
  ...
  return /* record */[
          ...
          /* removed : false */0,
          /* meta */match$4 !== undefined ? /* Some */[JSON.parse(match$4)] : /* None */0
        ];
}
...
function updateOrderToJs(id, rev, originalOrder, updateOrder) {
  ...
  var match$2 = updateOrder[/* meta */6];
  return {
          _id: id,
          _rev: rev,
          ...
          meta: match$2 ? jsonToString(match$2[0]) : undefined,
