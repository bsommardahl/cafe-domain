...
function mapToJs(prod) {
  return {
          sku: prod[/* sku */0],
          name: prod[/* name */1],
          suggestedPrice: prod[/* suggestedPrice */5],
          onHand: prod[/* onHand */3],
          department: prod[/* department */4],
          tags: $$Array.of_list(prod[/* tags */2]),
          taxCalculation: Tax.Calculation[/* toDelimitedString */0](prod[/* taxCalculation */6])
        };
}
...
function mapToJsWithRev(id, rev, prod) {
  return {
          ...
          suggestedPrice: prod[/* suggestedPrice */5],
          tags: prod[/* tags */3],
          onHand: prod[/* onHand */6],
          department: prod[/* department */4],
          taxCalculation: Tax.Calculation[/* toDelimitedString */0](prod[/* taxCalculation */7])
        };
}
