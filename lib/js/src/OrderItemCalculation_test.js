        ...
        describe("when calculating totals for an entire order", (function () {
                ...
                describe("with several items and a discount", (function () {
                        ...
                        Jest.test("the discount should be 10% of the subtotal", (function () {
                                return Jest.Expect[/* toEqual */12](5636, Jest.Expect[/* expect */0](totals[/* discounts */3]));
                              }));
                        Jest.test("the discount should be applied to the subtotal", (function () {
                                return Jest.Expect[/* toEqual */12](51992, Jest.Expect[/* expect */0](totals[/* subTotal */0]));
                              }));
                        Jest.test("the the tax should be calcualted per item and then rounded", (function () {
                                return Jest.Expect[/* toEqual */12](5072, Jest.Expect[/* expect */0](totals[/* tax */1]));
                              }));
                        return Jest.test("the total should be the sum of all other subtotals", (function () {
                                      return Jest.Expect[/* toEqual */12](57064, Jest.Expect[/* expect */0](totals[/* total */2]));
                                    }));
                      }));
                describe("with one pizza and a discount", (function () {
                        ...
                        Jest.test("the discount should be 25% of the subtotal", (function () {
                                return Jest.Expect[/* toEqual */12](2500, Jest.Expect[/* expect */0](totals[/* discounts */3]));
                              }));
                        Jest.test("the discount should be applied to the subtotal", (function () {
                                return Jest.Expect[/* toEqual */12](8696, Jest.Expect[/* expect */0](totals[/* subTotal */0]));
                              }));
                        Jest.test("the the tax should be calcualted per item and then rounded", (function () {
                                return Jest.Expect[/* toEqual */12](1304, Jest.Expect[/* expect */0](totals[/* tax */1]));
                              }));
                        return Jest.test("the total should be the sum of all other subtotals", (function () {
                                      return Jest.Expect[/* toEqual */12](10000, Jest.Expect[/* expect */0](totals[/* total */2]));
                                    }));
                      }));
                return /* () */0;
              }));
                ...
                describe("when exempt tax calculation", (function () {
                        describe("and with a discount", (function () {
                                ...
                                Jest.test("the subtotal should be 900", (function () {
                                        return Jest.Expect[/* toEqual */12](9.09090909090909, Jest.Expect[/* expect */0](totals[/* subTotal */0]));
                                      }));
                                ...
                                Jest.test("it should have a 100 lemp discount", (function () {
                                        return Jest.Expect[/* toEqual */12](0.90909090909091, Jest.Expect[/* expect */0](totals[/* discounts */3]));
                                      }));
                ...
                describe("with total first tax calculation", (function () {
                        ...
                        describe("and with a low discount", (function () {
                                ...
                                Jest.test("the subtotal should be discounted and derrived from the total", (function () {
                                        return Jest.Expect[/* toEqual */12](8.695652173913043, Jest.Expect[/* expect */0](totals[/* subTotal */0]));
                                      }));
                                Jest.test("the total should be the discounted suggested price", (function () {
                                        return Jest.Expect[/* toEqual */12](9.999999999999998, Jest.Expect[/* expect */0](totals[/* total */2]));
                                      }));
                                Jest.test("it should have a discount", (function () {
                                        return Jest.Expect[/* toEqual */12](1.000000000000001, Jest.Expect[/* expect */0](totals[/* discounts */3]));
                                      }));
                                return Jest.test("it should return tax", (function () {
                                              return Jest.Expect[/* toEqual */12](1.3043478260869552, Jest.Expect[/* expect */0](totals[/* tax */1]));
                                            }));
                              }));
